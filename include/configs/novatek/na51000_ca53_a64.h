...
#define CONFIG_LINUX_SDRAM_START		_BOARD_LINUX_ADDR_
#if (CONFIG_UBOOT_SDRAM_BASE > CONFIG_LINUX_SDRAM_BASE)
#define CONFIG_NVT_RUNFW_SDRAM_BASE		(CONFIG_UBOOT_SDRAM_BASE - CONFIG_NVT_UIMAGE_SIZE - CONFIG_NVT_ALL_IN_ONE_IMG_SIZE)
#else
#define CONFIG_NVT_RUNFW_SDRAM_BASE		(CONFIG_LINUX_SDRAM_BASE + CONFIG_LINUX_SDRAM_SIZE - CONFIG_NVT_UIMAGE_SIZE - CONFIG_NVT_ALL_IN_ONE_IMG_SIZE)
#endif
