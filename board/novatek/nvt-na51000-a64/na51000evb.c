...
static struct mm_region na51000_a64_evb_mem_map[] = {
	{
	    .virt = 0x0UL,
		.phys = 0x0UL,
		.size = 0x20000000UL,
...
struct mm_region *mem_map = na51000_a64_evb_mem_map;
...
int board_init(void)
{
	...
	/* Let SMP slave cpu go to slave cpu init assembly */
	nvt_writel(CONFIG_UBOOT_SDRAM_BASE+gd->reloc_off , (ulong) 0xf0090104);
