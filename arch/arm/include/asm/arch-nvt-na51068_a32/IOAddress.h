...
// SDRAM Controller
#define IOADDR_DRAM_REG_BASE        (IOADDR_GLOBAL_BASE+0x0A000000)

// Top
#define IOADDR_TOP_REG_BASE         (IOADDR_GLOBAL_BASE+0x0E030000)

// CG
#define IOADDR_CG_REG_BASE          (IOADDR_GLOBAL_BASE+0x0E000000)

// PAD
#define IOADDR_PAD_REG_BASE         (IOADDR_GLOBAL_BASE+0x0E040000)

// Timer
#define IOADDR_TIMER_REG_BASE       (IOADDR_GLOBAL_BASE+0x0E8C0000)

// WDT (Watch Dog Timer)
#define IOADDR_WDT_REG_BASE         (IOADDR_GLOBAL_BASE+0x0E8A0000)

// RTC & Power Button
#define IOADDR_RTC_REG_BASE         (IOADDR_GLOBAL_BASE+0x0E880000)

// GPIO
#define IOADDR_GPIO_REG_BASE        (IOADDR_GLOBAL_BASE+0x0E400000)
...
// NAND
#define IOADDR_NAND_REG_BASE        (IOADDR_GLOBAL_BASE+0x0A900000)
