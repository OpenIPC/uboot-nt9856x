...
#define PCIE_TOP_REG_BASE				0x2f04f0000
#define PCIE_DBI_REG_BASE				0x2fd000000

#define	PCIE_SLV_oATU0_BASE			0x620000000 //RC oATU memory, (map to register)
#define	PCIE_SLV_oATU0_LIM			0x62fffffff
...
#define	PCIE_EP0_REG_BASE			0x620000000
