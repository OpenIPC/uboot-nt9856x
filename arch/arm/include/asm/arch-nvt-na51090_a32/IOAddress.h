...
// USB3
#define IOADDR_USB3_REG_BASE        (IOADDR_GLOBAL_BASE+0x00390000)
...
// RSA
#define IOADDR_RSA_REG_BASE         (IOADDR_GLOBAL_BASE+0x006A0000)

// Hash
#define IOADDR_HASH_REG_BASE        (IOADDR_GLOBAL_BASE+0x00700000)
