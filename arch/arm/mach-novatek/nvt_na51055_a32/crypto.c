...
static void crypto_dma_enable(u32 uiMode, u32 uiOPMode, u32 uiType, u32 SrcAddr, u32 DstAddr, u32 Len, u8 * Key, u8 * IV)
{
	UINT32 	uiReg;
...
s32 crypto_data_operation(EFUSE_OTP_KEY_SET_FIELD key_set, CRYPT_OP crypt_op_param)
{
	...
	crypto_dma_enable(CRYPTO_AES, crypt_op_param.op_mode, crypt_op_param.en_de_crypt, crypt_op_param.src_addr, crypt_op_param.dst_addr, crypt_op_param.length, NULL, (u8 *)crypt_op_param.iv);
...
s32 crypto_data_operation_by_key(UINT8 * key, CRYPT_OP crypt_op_param)
{
	...
	crypto_dma_enable(CRYPTO_AES, crypt_op_param.op_mode, crypt_op_param.en_de_crypt, crypt_op_param.src_addr, crypt_op_param.dst_addr, crypt_op_param.length, key, (u8 *)crypt_op_param.iv);
